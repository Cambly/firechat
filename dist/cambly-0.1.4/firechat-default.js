...
this["FirechatDefaultTemplates"]["templates/layout-full.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div id=\'firechat\' class=\'full\'><div id=\'firechat-tabs\' class=\'clearfix\'>\n<ul id=\'firechat-tab-list\' class=\'nav nav-tabs clearfix\'></ul>\n<div id=\'firechat-tab-content\' class=\'tab-content\'></div>\n</div><div id=\'firechat-footer\' class=\'clearfix\'></div>\n</div>';}return __p};
  ...
  Firechat.prototype.enterRoom = function(roomId) {
    ...
    self.getRoom(roomId, function(room) {
      ...
      self._roomRef.child(roomId).once('value', function(snapshot) {
        self._messageRef.child(roomId).limitToFirst(self._options.numMaxMessages).on('child_added', function(snapshot) {
        ...
        self._messageRef.child(roomId).limitToFirst(self._options.numMaxMessages).on('child_removed', function(snapshot) {
